...
**قانون سراسری مخزن:** هر پلاگینی که در این مخزن ساخته یا به‌روزرسانی می‌شود باید راست‌چین (RTL) و فارسی‌محور باشد و سازنده‌اش «رضا آسیابی» درج شود. جزئیات، قالب هدر و اسکریپت بررسی در اسکیل `rtl-plugin-standards` (مسیر `.claude/skills/rtl-plugin-standards/`).
