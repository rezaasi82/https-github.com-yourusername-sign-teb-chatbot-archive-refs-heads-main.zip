...
class ProviderFactory
{
    ...
    public function __construct(\Clinovix\Core\Settings $settings)
    {
     ...
     */
    public function create(string $id): ?\Clinovix\Ai\AiProviderInterface
    {
        ...
        switch ($id) {
            case 'openai':
                return new \Clinovix\Ai\ProviderOpenai($key);
            case 'gapgpt':
                return new \Clinovix\Ai\ProviderGapgpt($key);
            case 'anthropic':
                return new \Clinovix\Ai\ProviderAnthropic($key);
            default:
                return null;
        }
    }

    public function create_active(): ?\Clinovix\Ai\AiProviderInterface
    {
     ...
     */
    public function create_fallback(string $primary_id): ?\Clinovix\Ai\AiProviderInterface
    {
