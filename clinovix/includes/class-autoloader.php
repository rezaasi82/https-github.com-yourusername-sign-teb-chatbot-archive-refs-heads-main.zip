<?php
/**
 * PSR-4 style autoloader for the Clinovix namespace.
 *
 * @package Clinovix
 */
...
class Autoloader
{
    ...
    /**
     * Resolve Clinovix\Sub\ClassName to includes/sub/class-class-name.php.
     */
