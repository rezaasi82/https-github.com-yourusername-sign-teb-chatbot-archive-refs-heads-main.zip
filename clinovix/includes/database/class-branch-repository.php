...
class BranchRepository
{
    ...
    {
        global $wpdb;
        $table = \Clinovix\Database\Schema::branches_table();
    ...
    public function create(array $data): int
    {
        ...
        $wpdb->insert(
            \Clinovix\Database\Schema::branches_table(),
            [
                'name'       => $data['name'],
    ...
    {
        global $wpdb;
        $wpdb->delete(\Clinovix\Database\Schema::branches_table(), ['id' => $id], ['%d']);
        $wpdb->update(
            \Clinovix\Database\Schema::conversations_table(),
            ['branch_id' => null],
            ['branch_id' => $id],
            ['%d'],
            ['%d']
