...
class SyncStatus
{
    ...
    public function __construct(?\Clinovix\Database\SyncLogRepository $logs = null)
    {
        $this->logs = $logs ?? new \Clinovix\Database\SyncLogRepository();
    }
    ...
    public static function badge(string $status): string
    {
        ...
        return '<span class="clx-pill" style="background:' . esc_attr($bg) . ';color:' . esc_attr($fg) . '">' . esc_html($label) . '</span>';
    }
}
