...
abstract class SmsProviderBase implements \Clinovix\Notifications\SmsProviderInterface
{
    protected \Clinovix\Core\Settings $settings;
    ...
    {
        return ['ok' => false, 'error' => __('این سرویس از ارسال الگو پشتیبانی نمی‌کند.', 'clinovix')];
    }
    ...
    {
        return \Clinovix\Notifications\SmsManager::key();
    }

    /** Optional second credential (e.g. MeliPayamak password). */
    protected function api_secret(): string
    {
        return \Clinovix\Notifications\SmsManager::secret();
    }
