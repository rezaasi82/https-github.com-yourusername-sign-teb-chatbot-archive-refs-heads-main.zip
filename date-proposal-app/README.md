...
باز کردن اپ بدون hash، صفحه‌ی **ساخت کارت** را می‌آورد: اسم طرف، اسم خودت، سوال دلخواه،
یه پیام کوچیک برای آخرش، و آیدی تلگرامت. لینک همان‌طور که تایپ می‌کنی ساخته می‌شود.
...
ساخت لینک → ۱. سوال + دکمه‌ی «نه»ی بازیگوش → ۲. انتخاب روز و ساعت → ۳. منو و اکسترا → ۴. جشن، بلیط قرار و فرستادن جواب.
