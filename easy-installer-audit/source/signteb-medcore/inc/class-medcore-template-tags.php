...
// تگ‌های باز/بسته‌ی PHP داخل آن‌ها اجرا نمی‌شوند و به‌صورت متن خام چاپ می‌شوند.
...
// (توجه: در این کامنت عمداً از نوشتن دنباله‌ی بستن تگ PHP خودداری شده، چون
//  آن دنباله حتی داخل کامنت تک‌خطی هم بلوک PHP را می‌بندد و ادامه‌ی فایل را
//  به متن خام تبدیل می‌کند.)
