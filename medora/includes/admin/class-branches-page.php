...
class BranchesPage
{
    private const NONCE = 'mdr_branches';

    public function register(): void
    {
        add_action('admin_menu', [$this, 'menu'], 20);
        add_action('admin_post_mdr_branch_save', [$this, 'handle_save']);
        add_action('admin_post_mdr_branch_delete', [$this, 'handle_delete']);
    }
    ...
    public function handle_save(): void
    {
        ...
        wp_safe_redirect(admin_url('admin.php?page=mdr-branches&saved=1'));
        exit;
    }
    ...
    public function handle_delete(): void
    {
        ...
        wp_safe_redirect(admin_url('admin.php?page=mdr-branches&deleted=1'));
        exit;
    }
    ...
    public function render(): void
    {
        ...
        include MDR_DIR . 'includes/admin/views/branches.php';
    }
}
