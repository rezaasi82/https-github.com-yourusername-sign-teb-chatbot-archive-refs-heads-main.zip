<?php
/**
 * PSR-4 style autoloader for the Medora namespace.
 *
 * @package Medora
 */
...
class Autoloader
{
    ...
    /**
     * Resolve Medora\Sub\ClassName to includes/sub/class-class-name.php.
     */
