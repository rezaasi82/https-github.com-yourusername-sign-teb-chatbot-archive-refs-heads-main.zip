...
class CloudClient
{
    public const OPTION_SECRET   = 'mdr_cloud_secret_enc';
    public const OPTION_REGISTERED = 'mdr_cloud_registered';
    private const CRON_HEARTBEAT = 'mdr_cloud_heartbeat';
    private const CRON_INSTALL   = 'mdr_cloud_install';
    ...
    private function telemetry(): array
    {
        return [
            ...
            'plugin_version' => defined('MDR_VERSION') ? MDR_VERSION : '',
