...
class ExportManager
{
    ...
    {
        add_action('mdr_webhook_retry', [$this, 'run_webhook_retry'], 10, 4);

        // Fire when a conversation is first detected as a lead.
        add_action('mdr_lead_detected', [$this, 'on_lead_detected'], 20, 2);
    }
    ...
    public function export_pdf(int $lead_id): array
    {
        ...
        do_action('mdr_pdf_generated', $lead_id, $result['url']);
