 ...
 *
 * Runs on the mdr_daily_rollup cron and writes one aggregated row per
 * (day, metric) into mdr_analytics, so long-range dashboards read a few
...
class Rollup
{
    public const CRON = 'mdr_daily_rollup';
