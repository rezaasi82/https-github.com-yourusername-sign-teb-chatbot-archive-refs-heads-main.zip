...
- **صفحه ورود سفارشی (`LoginCustomizer`)**: بازطراحی کامل `wp-login.php` با پس‌زمینه گرادیانی برند، کارت شیشه‌ای، لوگوی تقویم، پیام خوش‌آمد فارسی و فیلدهای مدرن — استایل فقط در صفحه ورود لود می‌شود (سازگار با قانون conditional asset loading)
