...
class CouponController
{
    ...
    public function __construct(CouponEngine $coupon_engine)
    {
    ...
    {
        register_rest_route('nobatyar/v1', '/coupons/validate', [
    ...
    public function validate_coupon(\WP_REST_Request $request)
    {
        ...
        $coupon = $this->coupon_engine->validate(
     ...
     * PackageController so coupon validation requests count against the
     * same overall request budget.
     *
