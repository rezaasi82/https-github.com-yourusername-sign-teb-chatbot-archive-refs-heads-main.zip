...
class PageHeader
{
    ...
    {
        echo '<div class="pzr-head">';
        echo '<span class="pzr-head-mark" aria-hidden="true">&#128172;</span>';

        echo '<div class="pzr-head-text">';
        ...
        if ($chips) {
            echo '<div class="pzr-head-meta">';
            foreach ($chips as $chip) {
                $state = $chip['state'] ?? '';
                $class = 'pzr-chip';
                if ($state === 'on' || $state === 'off') {
                    $class .= ' pzr-chip-' . $state;
                }
    ...
    {
        echo '<div class="pzr-empty">';
        echo '<span class="pzr-empty-ico" aria-hidden="true">' . wp_kses_post($icon) . '</span>';
