...
class ProviderFactory
{
    ...
    public function __construct(\Pazira\Core\Settings $settings)
    {
     ...
     */
    public function create(string $id): ?\Pazira\Ai\AiProviderInterface
    {
        ...
        switch ($id) {
            case 'openai':
                return new \Pazira\Ai\ProviderOpenai($key);
            case 'gapgpt':
                return new \Pazira\Ai\ProviderGapgpt($key);
            case 'anthropic':
                return new \Pazira\Ai\ProviderAnthropic($key);
            default:
                return null;
        }
    }

    public function create_active(): ?\Pazira\Ai\AiProviderInterface
    {
     ...
     */
    public function create_fallback(string $primary_id): ?\Pazira\Ai\AiProviderInterface
    {
