<?php
/**
 * PSR-4 style autoloader for the Pazira namespace.
 *
 * @package Pazira
 */
...
class Autoloader
{
    ...
    /**
     * Resolve Pazira\Sub\ClassName to includes/sub/class-class-name.php.
     */
