...
class BranchRepository
{
    ...
    {
        global $wpdb;
        $table = \Pazira\Database\Schema::branches_table();
    ...
    public function create(array $data): int
    {
        ...
        $wpdb->insert(
            \Pazira\Database\Schema::branches_table(),
            [
                'name'       => $data['name'],
    ...
    {
        global $wpdb;
        $wpdb->delete(\Pazira\Database\Schema::branches_table(), ['id' => $id], ['%d']);
        $wpdb->update(
            \Pazira\Database\Schema::conversations_table(),
            ['branch_id' => null],
            ['branch_id' => $id],
            ['%d'],
            ['%d']
