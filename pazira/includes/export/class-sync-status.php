...
class SyncStatus
{
    ...
    public function __construct(?\Pazira\Database\SyncLogRepository $logs = null)
    {
        $this->logs = $logs ?? new \Pazira\Database\SyncLogRepository();
    }
    ...
    public static function badge(string $status): string
    {
        ...
        return '<span class="pzr-pill" style="background:' . esc_attr($bg) . ';color:' . esc_attr($fg) . '">' . esc_html($label) . '</span>';
    }
}
