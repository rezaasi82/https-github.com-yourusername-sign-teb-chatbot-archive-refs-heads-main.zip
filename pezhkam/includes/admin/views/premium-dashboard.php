...
<div class="wrap pzk-dash" dir="rtl">
    <div class="pzk-dash-inner">
        ...
        <div class="pzk-grid pzk-grid-4">
            <div class="pzk-tile"><span class="pzk-tile-ico">💬</span><span class="pzk-tile-num" data-count="<?php echo esc_attr($metrics['conversations']); ?>">0</span><span class="pzk-tile-label"><?php esc_html_e('کل گفتگوها', 'pezhkam'); ?></span></div>
            <div class="pzk-tile"><span class="pzk-tile-ico">🎯</span><span class="pzk-tile-num" data-count="<?php echo esc_attr($metrics['leads']); ?>">0</span><span class="pzk-tile-label"><?php esc_html_e('کل لیدها', 'pezhkam'); ?></span></div>
            <div class="pzk-tile"><span class="pzk-tile-ico">🔥</span><span class="pzk-tile-num" data-count="<?php echo esc_attr($metrics['hot_leads']); ?>">0</span><span class="pzk-tile-label"><?php esc_html_e('لیدهای داغ', 'pezhkam'); ?></span></div>
            <div class="pzk-tile"><span class="pzk-tile-ico">📈</span><span class="pzk-tile-num"><?php echo esc_html($metrics['conversion']); ?>٪</span><span class="pzk-tile-label"><?php esc_html_e('نرخ تبدیل', 'pezhkam'); ?></span></div>
            <div class="pzk-tile"><span class="pzk-tile-ico">📅</span><span class="pzk-tile-num" data-count="<?php echo esc_attr($metrics['clicks']['booking']); ?>">0</span><span class="pzk-tile-label"><?php esc_html_e('کلیک رزرو', 'pezhkam'); ?></span></div>
            <div class="pzk-tile"><span class="pzk-tile-ico">💬</span><span class="pzk-tile-num" data-count="<?php echo esc_attr($metrics['clicks']['whatsapp']); ?>">0</span><span class="pzk-tile-label"><?php esc_html_e('کلیک واتساپ', 'pezhkam'); ?></span></div>
            <div class="pzk-tile"><span class="pzk-tile-ico">📞</span><span class="pzk-tile-num" data-count="<?php echo esc_attr($metrics['clicks']['call']); ?>">0</span><span class="pzk-tile-label"><?php esc_html_e('کلیک تماس', 'pezhkam'); ?></span></div>
            <div class="pzk-tile pzk-tile-int <?php echo esc_attr($int_class); ?>"><span class="pzk-tile-ico">🛡️</span><span class="pzk-int-badge" id="pzk-int-badge"><?php echo esc_html($integrity['label']); ?></span><span class="pzk-tile-label"><?php esc_html_e('یکپارچگی و امنیت', 'pezhkam'); ?></span></div>
        </div>
