...
class BranchRepository
{
    ...
    {
        global $wpdb;
        $table = \Pezhkam\Database\Schema::branches_table();
    ...
    public function create(array $data): int
    {
        ...
        $wpdb->insert(
            \Pezhkam\Database\Schema::branches_table(),
            [
                'name'       => $data['name'],
    ...
    {
        global $wpdb;
        $wpdb->delete(\Pezhkam\Database\Schema::branches_table(), ['id' => $id], ['%d']);
        $wpdb->update(
            \Pezhkam\Database\Schema::conversations_table(),
            ['branch_id' => null],
            ['branch_id' => $id],
            ['%d'],
            ['%d']
