...
class SyncStatus
{
    ...
    public function __construct(?\Pezhkam\Database\SyncLogRepository $logs = null)
    {
        $this->logs = $logs ?? new \Pezhkam\Database\SyncLogRepository();
    }
    ...
    public static function badge(string $status): string
    {
        ...
        return '<span class="pzk-pill" style="background:' . esc_attr($bg) . ';color:' . esc_attr($fg) . '">' . esc_html($label) . '</span>';
    }
}
