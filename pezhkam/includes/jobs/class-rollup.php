 ...
 *
 * Runs on the pzk_daily_rollup cron and writes one aggregated row per
 * (day, metric) into pzk_analytics, so long-range dashboards read a few
...
class Rollup
{
    public const CRON = 'pzk_daily_rollup';
    ...
    private function day_metrics(string $day): array
    {
        ...
        $events = \Pezhkam\Database\Schema::events_table();
        $start  = $day . ' 00:00:00';
        $end    = $day . ' 23:59:59';
