...
class MedicalSafetyFilter
{
    ...
    private const DISCLAIMER = 'توجه: این اطلاعات عمومی است و جایگزین مشاوره و ویزیت حضوری پزشک نیست. برای بررسی دقیق وضعیت‌تان، رزرو نوبت را پیشنهاد می‌کنم.';
    ...
    public function screen_input(string $message): array
    {
        if ($this->contains($message, self::EMERGENCY_TERMS)) {
            ...
            return [
                'emergency' => true,
                'reply'     => "وضعیت شما ممکن است فوری باشد. لطفاً همین حالا با اورژانس {$emergency} تماس بگیرید{$extra}. سلامتی شما در اولویت است — این چت جایگزین کمک فوری پزشکی نیست.",
            ];
        }
