	...
	public static function general_surgery(): array {
		return [
			...
			'treatment' => [
				...
				// Injectable weight-loss (GLP-1 analogues) — non-surgical option
				'تزریق لاغری', 'آمپول لاغری', 'تزریق آمپول لاغری', 'قلم لاغری', 'دارودرمانی چاقی',
				'درمان دارویی چاقی',
			],
			'drug'      => [
				'مانجارو', 'اسپارتینا', 'اوزمپیک', 'ویگووی', 'ویگوی', 'ساکسندا',
				'سماگلوتاید', 'تیرزپاتاید', 'ترزپاتاید', 'لیراگلوتاید', 'قرص لاغری',
			],
			'specialty' => [
				'جراح چاقی', 'جراح عمومی', 'فلوشیپ جراحی چاقی', 'جراح لاپاراسکوپی',
				'فوق تخصص جراحی چاقی', 'جراح فتق', 'متخصص تغذیه',
			],
			'body_part' => [
