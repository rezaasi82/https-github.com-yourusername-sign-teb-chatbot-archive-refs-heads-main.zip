...
final class ContentController extends AbstractController {
	...
	public function __construct(
		...
		private PenaltyRadarDetector $penalties,
	...
	public function penalties( \WP_REST_Request $request ): \WP_REST_Response|\WP_Error {
		$guard = $this->guard_feature( 'core_detectors' );
		if ( is_wp_error( $guard ) ) {
			return $guard;
		}
		...
		return rest_ensure_response(
			$this->penalties->detect( (int) $request->get_param( 'days' ), (bool) $request->get_param( 'force' ) )
		);
	}
