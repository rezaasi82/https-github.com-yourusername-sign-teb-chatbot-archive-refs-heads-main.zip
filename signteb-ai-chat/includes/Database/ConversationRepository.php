...
/**
 * Repository for chat conversations (mirrors the Reviews-module Repository
 * pattern from the mother project: all SQL is prepared and centralized here).
 */
class ConversationRepository
{
    ...
    /**
     * Mark a conversation as a converted lead with the CTA that triggered it.
     */
    ...
    /**
     * Aggregate stats for the admin dashboard (ROI proof).
     */
