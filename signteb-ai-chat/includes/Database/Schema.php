...
/**
 * Owns table names and the dbDelta schema. Repositories depend on this only.
 */
class Schema
{
    ...
    {
        global $wpdb;
        return $wpdb->prefix . 'stmc_chat_conversations';
    }

    public static function messages_table(): string
    {
        global $wpdb;
        return $wpdb->prefix . 'stmc_chat_messages';
    }
    ...
    public static function install(): void
    {
        ...
        update_option('stmc_chat_db_version', self::DB_VERSION);
    }
