...
صفحه ورود وردپرس (`wp-login.php`) با طراحی اختصاصی برای سایت‌هایی که **SignTeb.com** طراحی می‌کند: تم تیره الهام‌گرفته از GitHub Dark، لهجه‌های طلایی VIP، لوگوی صلیب پزشکی + استتوسکوپ، ایکون‌های شناور و امضای «طراحی و توسعه: SignTeb.com».
