...
class PageHeader
{
    ...
    {
        echo '<div class="swc-head">';
        echo '<span class="swc-head-mark" aria-hidden="true">&#128172;</span>';

        echo '<div class="swc-head-text">';
        ...
        if ($chips) {
            echo '<div class="swc-head-meta">';
            foreach ($chips as $chip) {
                $state = $chip['state'] ?? '';
                $class = 'swc-chip';
                if ($state === 'on' || $state === 'off') {
                    $class .= ' swc-chip-' . $state;
                }
    ...
    {
        echo '<div class="swc-empty">';
        echo '<span class="swc-empty-ico" aria-hidden="true">' . wp_kses_post($icon) . '</span>';
