...
$status_map = (new \SignTeb\WebChat\Export\SyncStatus())->for_leads($lead_ids);
        ...
        <?php foreach ($items as $c) :
            ...
            <tr data-lead="<?php echo esc_attr($c->id); ?>">
                ...
                <td>
                    ...
                    <span class="swc-status-pill" style="background:<?php echo esc_attr(\SignTeb\WebChat\Crm\LeadCrm::color($lead_status)); ?>"><?php echo esc_html(\SignTeb\WebChat\Crm\LeadCrm::label($lead_status)); ?></span>
                ...
                <td><?php echo wp_kses_post(\SignTeb\WebChat\Export\SyncStatus::badge($st['pdf'])); ?></td>
                <td><?php echo wp_kses_post(\SignTeb\WebChat\Export\SyncStatus::badge($st['google_sheets'])); ?></td>
                <td><?php echo wp_kses_post(\SignTeb\WebChat\Export\SyncStatus::badge($st['webhook'])); ?></td>
