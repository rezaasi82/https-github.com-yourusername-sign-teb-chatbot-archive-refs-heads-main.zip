...
class ProviderFactory
{
     ...
     */
    public function create(string $id): ?\SignTeb\WebChat\Ai\AiProviderInterface
    {
        ...
        switch ($id) {
            case 'openai':
                return new \SignTeb\WebChat\Ai\ProviderOpenai($key);
            case 'gapgpt':
                return new \SignTeb\WebChat\Ai\ProviderGapgpt($key);
            case 'anthropic':
                return new \SignTeb\WebChat\Ai\ProviderAnthropic($key);
            default:
                return null;
        }
    }

    public function create_active(): ?\SignTeb\WebChat\Ai\AiProviderInterface
    {
     ...
     */
    public function create_fallback(string $primary_id): ?\SignTeb\WebChat\Ai\AiProviderInterface
    {
