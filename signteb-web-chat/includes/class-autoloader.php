<?php
/**
 * PSR-4 style autoloader for the SignTeb\WebChat namespace.
 *
 * @package SignTeb_Web_Chat
 */

namespace SignTeb\WebChat;
...
class Autoloader
{
    private const PREFIX = 'SignTeb\\WebChat\\';
    ...
    /**
     * Resolve SignTeb\WebChat\Sub\ClassName to includes/sub/class-class-name.php.
     */
