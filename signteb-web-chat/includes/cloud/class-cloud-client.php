...
namespace SignTeb\WebChat\Cloud;
...
class CloudClient
{
    ...
    {
        global $wpdb;
        $conv = \SignTeb\WebChat\Database\Schema::conversations_table();
        $msg  = \SignTeb\WebChat\Database\Schema::messages_table();
        return [
            ...
            'active_24h' => (new \SignTeb\WebChat\Database\ConversationRepository())->active_count(24),
        ];
    }
