...
class BranchRepository
{
    ...
    {
        global $wpdb;
        $table = \SignTeb\WebChat\Database\Schema::branches_table();
    ...
    public function create(array $data): int
    {
        ...
        $wpdb->insert(
            \SignTeb\WebChat\Database\Schema::branches_table(),
            [
                'name'       => $data['name'],
    ...
    {
        global $wpdb;
        $wpdb->delete(\SignTeb\WebChat\Database\Schema::branches_table(), ['id' => $id], ['%d']);
        $wpdb->update(
            \SignTeb\WebChat\Database\Schema::conversations_table(),
            ['branch_id' => null],
            ['branch_id' => $id],
            ['%d'],
            ['%d']
