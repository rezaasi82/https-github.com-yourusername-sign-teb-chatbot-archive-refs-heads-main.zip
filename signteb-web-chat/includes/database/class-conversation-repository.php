...
class ConversationRepository
{
    ...
    {
        global $wpdb;
        $table = \SignTeb\WebChat\Database\Schema::conversations_table();
    ...
    public function set_patient(int $conversation_id, string $name, string $phone): void
    {
        ...
        global $wpdb;
        $wpdb->update(\SignTeb\WebChat\Database\Schema::conversations_table(), $data, ['id' => $conversation_id], $formats, ['%d']);
    }
