...
class SyncLogRepository
{
    ...
    public function add(int $lead_id, string $provider, string $event, string $status, array $extra = []): int
    {
        ...
        $wpdb->insert(
            \SignTeb\WebChat\Database\Schema::sync_logs_table(),
            [
                'lead_id'     => $lead_id,
                'provider'    => $provider,
                'event'       => $event,
    ...
    public function update(int $id, string $status, array $extra = []): void
    {
        ...
        $wpdb->update(\SignTeb\WebChat\Database\Schema::sync_logs_table(), $data, ['id' => $id], $formats, ['%d']);
    }
    ...
    {
        global $wpdb;
        $table = \SignTeb\WebChat\Database\Schema::sync_logs_table();
