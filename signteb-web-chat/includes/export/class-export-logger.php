...
class ExportLogger
{
    private \SignTeb\WebChat\Database\SyncLogRepository $repo;

    public function __construct(?\SignTeb\WebChat\Database\SyncLogRepository $repo = null)
    {
        $this->repo = $repo ?? new \SignTeb\WebChat\Database\SyncLogRepository();
    }
