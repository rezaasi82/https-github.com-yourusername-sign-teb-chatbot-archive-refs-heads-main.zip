...
class LeadPayload
{
    ...
    public function __construct(?\SignTeb\WebChat\Database\ConversationRepository $conversations = null, ?\SignTeb\WebChat\Database\MessageRepository $messages = null)
    {
        $this->conversations = $conversations ?? new \SignTeb\WebChat\Database\ConversationRepository();
        $this->messages      = $messages ?? new \SignTeb\WebChat\Database\MessageRepository();
    }
