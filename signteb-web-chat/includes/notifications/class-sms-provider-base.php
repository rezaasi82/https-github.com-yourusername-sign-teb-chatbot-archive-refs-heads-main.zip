...
abstract class SmsProviderBase implements \SignTeb\WebChat\Notifications\SmsProviderInterface
{
    protected \SignTeb\WebChat\Core\Settings $settings;
    ...
    {
        return \SignTeb\WebChat\Notifications\SmsManager::key();
    }

    /** Optional second credential (e.g. MeliPayamak password). */
    protected function api_secret(): string
    {
        return \SignTeb\WebChat\Notifications\SmsManager::secret();
    }
